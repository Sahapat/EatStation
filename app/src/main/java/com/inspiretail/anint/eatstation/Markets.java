...
public class Markets {
    ...
    private static Detail[] m_details = {
                    ...
                    new Detail("Brown Sugar Bistro & Clean Food","BTS สะพานควาย","698/10 อาคาร ideomix ชั้น2 ถนนพหลโยธิน แขวงสามเสนไท เขตพญาไท กรุงเทพฯ 10400","ทุกวัน 10:00 - 22:00","100 - 350 บาท",
                    ...
                    new Detail("นำชัย เนื้อตุ๋น หมูตุ๋น","MRT ตลาดบางใหญ่","ซอยหมู่บ้านบางใหญ่ซิตี้เซ็นเตอร์ นนทบุรี๖๗(ข้างคริสตจักรแสงสันติภาพ)","ทุกวัน 07:30 - 16:00","ต่ำกว่า 100",
                    R.drawable.img_view31,new Detail.Location(13.879382f, 100.407552f)),

                    new Detail("เย็นตาโฟทรงเครื่อง","MRT ตลาดบางใหญ่","ถนนบางใหญ่ซิตี้ นนทบุรี(เข้าทางบางใหญ่ซิตี้ ร้านอยู่ซ้ายมือ ติดร้านข้าวขาหมูกรอบ)","จันทร์ 11:00 - 21:00,\nพุธ - อาทิตย์ 11:00 - 21:00","ต่ำกว่า 100",
                    R.drawable.img_view32,new Detail.Location(13.878590f, 100.407544f)),

                    new Detail("ตี๋ข้าวมันไก่ ตลาดบางใหญ่","MRT ตลาดบางใหญ่","นนทบุรี(อยู่ถนนเส้นหลักของทางเข้าฝั่งอาคารพาณิชย์)","ทุกวัน 07:00 - 17:30","ต่ำกว่า 100",
                    R.drawable.img_view33,new Detail.Location(13.879474f, 100.406078f)),

                    new Detail("หมูสะเต๊ะอาซ้อ","MRT สะพานพระนั่งเกล้า","54/74 ต.บางกระสอ อ.เมือง จ.นนทบุรี(ลง MRT สถานีสะพานพระนั่งเกล้า ลง Exit 2)","ทุกวัน 10:00 - 22:00","100 - 200 บาท",
                    R.drawable.img_view34,new Detail.Location(13.869848f, 100.481520f)),

                    new Detail("นิตยาไก่ย่าง","MRT สะพานพระนั่งเกล้า","ถนนรัตนาธิเบศร์ นนทบุรี(บริเวณแยกสะพานพระนั่งเกล้า)","ทุกวัน 10:00 - 22:00","101 - 250 บาท",
                    R.drawable.img_view35,new Detail.Location(13.869507f, 100.486648f)),

                    new Detail("กิน นม นอน","MRT สะพานพระนั่งเกล้า","ถนนนนทบุรี แยกพระนั่งเกล้า นนทบุรี(ติดทางขึ้น สถานีสะพานพระนั่งเกล้า)","ทุกวัน 12:00 - 22:00","101 - 250 บาท",
                    R.drawable.img_view36,new Detail.Location(13.870399f, 100.481821f)),
    };
    private Markets() {
    }
